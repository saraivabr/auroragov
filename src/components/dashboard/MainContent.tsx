...
import { MessageSquare, Languages, FileText, Newspaper, Paperclip, Lightbulb, Search, Wand2, Mic, ChevronUp, Settings2 } from 'lucide-react';
...
export function MainContent() {
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#2a2a2a]">
      ...
      <div className="fixed bottom-0 left-[280px] right-0 bg-[#2a2a2a] border-t border-gray-800 p-4">
